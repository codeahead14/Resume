...
%%% Added for list items in one line
...
%%% Essentials
\name{Gaurav Jain}{}
\address{C 9/15, Vikramnagar Housing Colony, AHMEDABAD-380015, INDIA}
\mobile{(+91) 9601578417} 
%%% Social
\email{gaurav.jain14@hotmail.com}
\github{codeahead14}
\linkedin{gaurav-jain-53993172}
%%% Optionals
\position{Scientist/Engineer - ISRO}
...
\import{\sectiondir}{undergrad_courses.tex}
